...
?>
    ...
    <section id="intro" class="intro">
        ...
        <div class="slogan">
            <h2>Welcome to <span class="text_color">TaiwanTour</span> </h2>
            <h4>Plan your journey in Taiwan. We will be your tour guide.</h4>
        </div>
        ...
        <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" align="center" style="padding-bottom: 10px">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                            </button>
                        </div>
                        <div class="row" style="text-align:center">
                            <button id="register_login_btn" type="button" class="btn btn-link col-xs-6 select">Log In</button>
                            <button id="login_register_btn" type="button" class="btn btn-link col-xs 6">Register</button>
                            <hr>
                        </div>
                        <!-- Begin # DIV Form -->
                        <div id="div-forms">
                            ...
                            <form id="login-form"  method='post'>
                                ...
                                <div class="modal-footer">
                                    <div>
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg btn-block" id="login-btn">Login</button>
                                    </div>
                                    <!-- <div>
                            ...
                            <form id="register-form" style="display:none;" method='post'>
                                <div class="modal-body">
                                    ...
                                    <input id="register_password_2" class="form-control" type="password" placeholder="Type again" required>
                                </div>
                                <div class="modal-footer">
                                    <div>
                                        <div class="error" id="regerror"></div> 
                                        <button type="submit" class="btn btn-primary btn-lg btn-block" id="reg-btn" style="background-color: #1CB94E">Register</button>
                                    </div>
                                    <!-- <div>
